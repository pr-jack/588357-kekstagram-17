...
var changeEffects = function (evt) {
  if (evt.target.value === 'none') {
    ...
    var curentEffect = imgUploadPreview.classList.add('effects__preview--' + evt.target.value);
  }
  return curentEffect;
};
